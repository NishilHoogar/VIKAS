...
if(isset($_POST['name'])){
    ...
    $pass = $_POST['pass'];
    $sql = "INSERT INTO `vikas`.`join` (`name`, `email`, `phone`, `regestration`, `pass_word`, `date`) VALUES ('$name', '$email', '$phone', '$register', '$pass', current_timestamp());";
    // echo $sql;
...
<body class="full-height-grow">
    <div class="container full-height-grow">
        ...
        <section class="join-main-section">
            ...
            <form class="join-form" action="join1.php" method="post">
    ...
    <footer class="main-footer">
      ...
      <!--INSERT INTO `join` (`sno`, `name`, `email`, `phone`, `regestration`, `pass_word`, `date`) VALUES ('2', 'FAIZ', 'faiz@123.com', '787879090', '111112212', '12111111h', current_timestamp());-->
    </body>
    </html>
